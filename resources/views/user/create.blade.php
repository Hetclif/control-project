            ...
            <div class="row">
                <form action="{{route('user.store')}}" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{old('name')}}" name="name" class="form-control" placeholder="Логин">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{old('first_name')}}" name="first_name" class="form-control" placeholder="Имя">
                    </div>
                    <div class="form-group">
